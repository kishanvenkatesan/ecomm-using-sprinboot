...
<link rel="stylesheet"
	...
	crossorigin="anonymous">
<title>Smart Internz Book Store</title>
</head>

<body  style="background-color: rgb(102, 50, 205)";>
	...
	<div class="jumbotron text-center" style="background-color: aquamarine;">
		...
		<p>Manage your Smart Internz Book Shop</p>
	</div><br>
	<div class="container-fluid"  >
			...
			<div class="col-sm-3">
				<div class="card border border-info" style="background-color: white;">
					<div class="card-body text-center">
						...
						<!-- <p>---------------------------------------------</p> -->
						<p class="card-text">Manage Book categories section here</p>
			...
			<div class="col-sm-3">
				<div class="card" style="background-color: white;">
					<div class="card-body text-center">
						...
						<!-- <p>---------------------------------------------</p> -->
						<p class="card-text">Manage all the Books here.</p>
